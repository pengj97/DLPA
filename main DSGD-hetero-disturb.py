...
from ByrdLab.attack import (label_flipping, dynamic_label_flipping)
from ByrdLab.decentralizedAlgorithm import DSGD_compute_hetero_disturbance
...
from ByrdLab.library.dataset import cifar100
...
if args.aggregation == 'no-comm':
    ...
    aggregation = D_centered_clipping(graph, threshold=100)
elif args.aggregation == 'scc':
    aggregation = D_self_centered_clipping(
        graph, threshold_selection='parameter', threshold=0.1)
